...
public:
	...
	vector<double> x_val_A; vector<double> x_val_B; vector<double> x_val_B_old;
	vector<vector<vector<vector<vector<double > > > > >  flow_val_A;
	vector<vector<vector<vector<vector<double > > > > >  flow_val_B;
	vector<vector<vector<vector<vector<double > > > > >  flow_val_B_old;
	vector<vector<vector<vector<double > > > > re_val_A;
	vector<vector<vector<vector<double > > > > re_val_B;
	vector<vector<vector<vector<double > > > > re_val_B_old;
	vector<vector<vector<vector<double > > > > dmd_val_A;
	vector<vector<vector<vector<double > > > > dmd_val_B;
